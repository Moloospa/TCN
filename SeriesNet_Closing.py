...
model.fit(x_train, y_train, batch_size=10, epochs=100, verbose=1, validation_split=0.2, shuffle=True, callbacks=[early_stopping, mcp_save, reduce_lr_loss, tensorboard_callback])
